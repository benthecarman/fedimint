...
use crate::pay::{LightningPayFunded, LightningPayRefund, LightningPayStates, PayInvoicePayload};
use crate::receive::{
...
mod tests {
    ...
    use crate::db::{
        get_v1_migrated_state, get_v2_migrated_state, get_v4_migrated_state, write_new_pay_state,
    };
